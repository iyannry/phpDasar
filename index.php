...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nim && $nama && $alamat && $fakultas) {
        if ($op == 'edit') { //untuk update
            ...
            $store   = "INSERT INTO mahasiswa (nim, nama, alamat, fakultas) VALUES ('$nim', '$nama', '$alamat', '$fakultas')";
            $q1     = mysqli_query($koneksi, $store);
            if ($q1) {
                $sukses     = "Berhasil memasukkan data baru";
            } else {
                $error      = "Gagal memasukkan data baru <br>" . $koneksi->error;
            }
        }
    } else {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="nama" class="form-label">Fakultas</label><br>
                    ...
                    <div class="col-12">
                        <button type="submit" role="button" name="simpan" id="simpan" class="btn btn-primary"> SIMPAN </button>
                    </div>
                </form>
            </div>
